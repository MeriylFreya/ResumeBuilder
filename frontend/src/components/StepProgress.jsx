...
const StepProgress = ({progress}) => {
  return (
    ...
    <div className='relative w-full h-4 bg-white/5 backdrop-blur-2x1 overflow-hidden rounded-fulll border border-white/10'>
        <div className='absolute inset-0 bg-gradient-to-r from-violet-500/20 to-fuchsia-500/20 animate-pulse'/>
        <div className='relative h-full bg-gragient-to-r from-violet-500 via-fuchsia-500 to-violet-600
        ...
        <div className='flex items-center gap-2'>
            {progress === 100 && (
                ...
                flex items-center justify-center'>
                    <Check sixe={12} className='text-white'/> 
                </div> 
            )}
        </div>
    </div>
